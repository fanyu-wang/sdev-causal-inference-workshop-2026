# Causal Inference Workshop (Spring 2026)
Materials for Sustainable Development PhD Spring 2026 Causal Inference Workshop

Based on Claire Palandri's [2022 version](https://clairepalandri.github.io/docs/CIworkshop_syllabus.pdf) and Anna Papp's [2024 version](https://github.com/pappanna/causal_inference_workshop) of the workshop
...
- Week 9: Inference
- Week 10: Field experiment
- Week 11: Fixed effects, climate regressions, remote sensing
- Week 12: Other topics and Wrap-up
...
- Very cool [LLM visualization](https://bbycroft.net/llm)
